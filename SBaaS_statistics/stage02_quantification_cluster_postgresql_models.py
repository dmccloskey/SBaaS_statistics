...
class data_stage02_quantification_cluster_impfeat(Base):
    __tablename__ = 'data_stage02_quantification_cluster_impfeat'
    id = Column(Integer, Sequence('data_stage02_quantification_cluster_impfeat_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    response_name = Column(String(100))
    test_size = Column(Float);

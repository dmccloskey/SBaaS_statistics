        ...
        for features_cnt,features in enumerate(features_I):
            ...
            if features == 'calculated_concentration':
                ...
                for feature_units in feature_units_I:
                    ...
                    elif hasattr(query_instance_descStats, 'get_allCVs_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingAverages'):
                        data_hist = query_instance_descStats.get_allCVs_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingAverages(analysis_id_I,feature_units);
                    else:
                        print('query instance does not have the required method.');
                    #make the bins for the histogram
                    if data_hist:

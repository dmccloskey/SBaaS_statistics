...
class data_stage02_quantification_svm_responseClassification(Base):
    __tablename__ = 'data_stage02_quantification_svm_responseClassification'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_responseClassification_id_seq'), primary_key=True)
...
class data_stage02_quantification_svm_impfeat(Base):
    ...
    def __repr__json__(self):
        return json.dumps(self.__repr__dict__())
class data_stage02_quantification_svm_hyperparameter(Base):
    __tablename__ = 'data_stage02_quantification_svm_hyperparameter'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_hyperparameter_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    pipeline_id = Column(String(50))
    ...
    def __repr__json__(self):
        return json.dumps(self.__repr__dict__())
class data_stage02_quantification_svm_pipeline(Base):
    __tablename__ = 'data_stage02_quantification_svm_pipeline'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_pipeline_id_seq'), primary_key=True)
...
#TODO: score the model on the test data
class data_stage02_quantification_svm_validation(Base):
    __tablename__ = 'data_stage02_quantification_svm_validation'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_validation_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    pipeline_id = Column(String(50))
    test_size = Column(Float);
    metric_method = Column(String(50));
...
#TODO:
#re-sample with or without substitution to generate error bars
#permute features or samples
#add io methods
class data_stage02_quantification_svm_resampledImpfeat(Base):
    __tablename__ = 'data_stage02_quantification_svm_resampledImpfeat'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_resampledImpfeat_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    pipeline_id = Column(String(50))
    response_name = Column(String(100))
    test_size = Column(Float);
    ...
    impfeat_options = Column(postgresql.JSON);
    impfeat_statistics = Column(postgresql.JSON); #std, zscore, pvalue, etc.
    resampling_method = Column(String(50)) #jackknifing, bootstraping, permutation along features or labels,
    resampling_options = Column(postgresql.JSON);
    calculated_concentration_units = Column(String(50))
    used_ = Column(Boolean);
    comment_ = Column(Text);
    ...
    def __init__(self, 
        ...
        self.used_ = row_dict_I['used_'];
        self.comment_ = row_dict_I['comment_'];
        self.resampling_method=row_dict_I['resampling_method'];
        self.resampling_options=row_dict_I['resampling_options'];
    ...
    def __repr__dict__(self):
        return {'id':self.id,
            ...
            "resampling_options":self.resampling_options,}
    
    def __repr__json__(self):
        return json.dumps(self.__repr__dict__())
class data_stage02_quantification_svm_resampledResponseClassification(Base):
    __tablename__ = 'data_stage02_quantification_svm_resampledResponseClassification'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_resampledResponseClassification_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    pipeline_id = Column(String(50))
    response_name = Column(String(100))
    sample_name_short = Column(String(100))
    ...
    def __repr__json__(self):
        return json.dumps(self.__repr__dict__())
class data_stage02_quantification_svm_resampledValidation(Base):
    __tablename__ = 'data_stage02_quantification_svm_resampledValidation'
    id = Column(Integer, Sequence('data_stage02_quantification_svm_resampledValidation_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    pipeline_id = Column(String(50))
    test_size = Column(Float);
    metric_method = Column(String(50));
    ...
    def __set__row__(self, analysis_id_I,
        ...
        self.metric_method=metric_method_I
        self.calculated_concentration_units=calculated_concentration_units_I
        self.resampling_method=resampling_method_I
        self.resampling_options=resampling_options_I
        self.used_=used__I
        self.comment_=comment__I

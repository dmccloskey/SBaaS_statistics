...
class stage02_quantification_svd_query(sbaas_template_query,
    ...
    #Query rows
    def get_rows_dataStage02QuantificationSVD(self,
                tables_I,
                query_I,
                output_O,
                dictColumn_I=None):
        """get rows by analysis ID from data_stage02_quantification_svd"""
        data_O = [];
        try:
            ...
            print(e);
        return data_O;
    def add_dataStage02QuantificationSVD(self,table_I,data_I):
        '''add rows of data_stage02_quantification_svd'''
        if data_I:
            try:
                ...
                print(e);
    def update_dataStage02QuantificationSVD(self,table_I,data_I):
        '''update rows of data_stage02_quantification_svd'''
        if data_I:
            try:
                model_I = self.convert_tableString2SqlalchemyModel(table_I);
    ...
    def initialize_dataStage02_quantification_svd(self,
            tables_I = [],):
        try:
            if not tables_I:
            ...
            print(e);
    def drop_dataStage02_quantification_svd(self,
            tables_I = [],):
        try:
            if not tables_I:
                tables_I = list(self.get_supportedTables().keys());

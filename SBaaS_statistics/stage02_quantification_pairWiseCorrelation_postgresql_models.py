...
class data_stage02_quantification_pairWiseCorrelationFeatures(Base):
    ...
    def __repr__json__(self):
        return json.dumps(self.__repr__dict__())
class data_stage02_quantification_pairWiseCorrelationFeatures_replicates(Base):
    #pairedttest
    __tablename__ = 'data_stage02_quantification_pairWiseCorrelationFeatures_replicates'
    id = Column(Integer, Sequence('data_stage02_quantification_pairWiseCorrelationFeatures_replicates_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    component_name_1 = Column(String(100))
    component_name_2 = Column(String(100))
    component_group_name_1 = Column(String(100))

...
class stage02_quantification_pls_io(stage02_quantification_pls_query,
    ...
    def export_dataStage02QuantificationPLSScores_js(self,analysis_id_I,axis_I=3,data_dir_I='tmp'):
    ...
    def export_dataStage02QuantificationPLSLoadings_js(self,analysis_id_I,axis_I=3,data_dir_I='tmp'):

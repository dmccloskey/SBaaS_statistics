...
class statistics_pairWiseCorrFeat(Base):
    __tablename__ = 'statistics_pairWiseCorrFeat'
    id = Column(Integer, Sequence('statistics_pairWiseCorrFeat_id_seq'), primary_key=True)
    analysis_id = Column(String(500))
    #experiment_id = Column(String(50))
    component_name_1 = Column(String(100))
    component_name_2 = Column(String(100))
    ...
    __table_args__ = (
        ...
        #required for tables with columns that are associated with a default sequence
        #see: http://stackoverflow.com/questions/14331128/sqlalchemy-raises-typeerror-when-an-insert-returns-no-rows
        #and: http://stackoverflow.com/questions/29237768/how-to-turn-off-sqlalchemy-implicit-returning
            )

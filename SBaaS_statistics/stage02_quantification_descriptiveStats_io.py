...
class stage02_quantification_descriptiveStats_io(stage02_quantification_descriptiveStats_query,
                                         ...
                                         stage02_quantification_normalization_query,
                                                 sbaas_template_io):
    def export_dataStage02QuantificationDescriptiveStats_js(self,analysis_id_I,plot_points_I=True,data_dir_I='tmp'):
        ...
        if plot_points_I:
            ...
            svgparameters_O = {"svgtype":'boxandwhiskersplot2d_02',"svgkeymap":[data1_keymap,data2_keymap],
                                'svgid':'svg1',

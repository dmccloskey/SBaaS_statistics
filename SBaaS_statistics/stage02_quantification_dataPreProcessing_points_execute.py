from .stage02_quantification_dataPreProcessing_points_io import stage02_quantification_dataPreProcessing_points_io
...
class stage02_quantification_dataPreProcessing_points_execute(stage02_quantification_dataPreProcessing_points_io,
    ...
    def execute_countMissingValues(self,
        ...
        if calculated_concentration_units_I:
            ...
            calculated_concentration_units = self.get_calculatedConcentrationUnits_analysisID_dataStage02QuantificationDataPreProcessingPoints(analysis_id_I);
        for cu_cnt,cu in enumerate(calculated_concentration_units):
            # query the number of rows
            ntablerows = None;
            ntablerows = self.getAggregateFunction_rows_analysisID_dataStage02QuantificationDataPreProcessingPoints(
                analysis_id_I,
                column_name_I = 'analysis_id',
                aggregate_function_I='count',
                query_I={'where':[
                    {"table_name":'data_stage02_quantification_dataPreProcessing_points',
            ...
            if value_I is None:
                ...
                nrows = None;
                nrows = self.getCount_componentNames_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(analysis_id_I,cu);
                # query the number of unique sample_name_short/experiment_id/time_point
                ncols = None;
                ncols = self.getCount_experimentIDAndSampleNameAbbreviationAndTimePoint_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(analysis_id_I,cu);
                nvalues = nrows*ncols;
                mv = nvalues - ntablerows;
            else:
                mv = None;
                mv = self.getAggregateFunction_rows_analysisID_dataStage02QuantificationDataPreProcessingPoints(
                    analysis_id_I,
                    column_name_I = 'analysis_id',
                    aggregate_function_I='count',
                    query_I={'where':[
            ...
            data_O.append(tmp);
        # add data to the DB
        self.add_rows_table('data_stage02_quantification_dataPreProcessing_points_mv',data_O);
    def execute_deleteMissingValues(self,
        ...
        for cu_cnt,cu in enumerate(calculated_concentration_units):            
            if value_I is None:
                ...
                cn_count = self.getGroup_componentNameAndCount_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(
                ...
                if set_used_false_I:
                    ...
                    if cn_mv: self.delete_rows_analysisIDAndCalculatedConcentrationUnitsAndComponentNames_dataStage02QuantificationDataPreProcessingPoints(
                        analysis_id_I = analysis_id_I,
                        calculated_concentration_units_I = cu,
                ...
                if set_used_false_I:
                    continue;
                    #TODO: update_rows_analysisIDAndCalculatedConcentrationUnitsAndCalculatedConcentrationValueAndOperator_dataStage02QuantificationDataPreProcessingPoints
                    #set used_ = False;
            
                else:
                    self.delete_rows_analysisIDAndCalculatedConcentrationUnitsAndFeatureValueAndOperator_dataStage02QuantificationDataPreProcessingPoints(
                        analysis_id_I = analysis_id_I,
                        calculated_concentration_units_I = cu,
                        feature_I = feature_I,
                        value_I = value_I,
    ...
    def execute_normalization(self,
        ...
        for cu in calculated_concentration_units:
            ...
            # get the data set
            data = [];
            #data = self.get_rows_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(
            #    analysis_id_I,
            #    cu,
            #    query_I={},
            #    output_O='listDict',
            #    dictColumn_I=None);
            data = self.get_RExpressionData_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(
                analysis_id_I,
                cu
                );
            ...
            #TODO: add support for LB,UB,IQ1,IQ3,Min,Max
                ...
                dpave_list = self.get_rows_analysisIDAndCalculatedConcentrationUnitsAndExperimentIDsAndSampleNameAbbreviationsAndTimePoints_dataStage02QuantificationDataPreProcessingPoints(
                        analysis_id_I,
                        cu,
        ...
        self.add_rows_table('data_stage02_quantification_dataPreProcessing_points',data_normalized);
        self.add_rows_table('data_stage02_quantification_dataPreProcessing_points_im',data_normalizations);
    ...
    def execute_imputeMissingValues(self,
        ...
        for cu in calculated_concentration_units:
            ...
            all_components = [];
            all_components = self.getGroup_componentNameAndComponentGroupName_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(
                analysis_id_I,cu);
            ...
            unique_groups = [];
            unique_groups = self.get_analysisIDAndExperimentIDsAndSampleNameAbbreviationsAndTimePoints_analysisIDAndCalculatedConcentrationUnits_dataStage02QuantificationDataPreProcessingPoints(
                analysis_id_I,cu,
                experiment_ids_I,
                sample_name_abbreviations_I,
                time_points_I);
            ...
            for unique_group in unique_groups.get_listDict():
                ...
                unique_components = [];
                unique_components = self.getGroup_componentNameAndComponentGroupName_analysisIDAndCalculatedConcentrationUnitsAndExperimentIDAndSampleNameAbbreviationAndTimePoint_dataStage02QuantificationDataPreProcessingPoints(
                ...
                if missing_components:
                    ...
                    for mcn in missing_components:
                        ...
                        if imputation_method_I == 'value':
                            ...
                            value_new = None;
                            value_new = self.getAggregateFunction_rows_analysisID_dataStage02QuantificationDataPreProcessingPoints(
                                analysis_id_I,
        ...
        if data_O:
            ...
            self.add_rows_table('data_stage02_quantification_dataPreProcessing_points_im',data_imputations);
        else:

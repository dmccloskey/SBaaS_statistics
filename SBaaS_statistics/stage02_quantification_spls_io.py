...
class stage02_quantification_spls_io(stage02_quantification_spls_query,
                                    sbaas_template_io):
    #TODO
    #1. copy over query methods from pls
    #2. copy over loadings/scores bar plots when finished in pls
    #3. fix any bugs when copying/pasting
    def export_dataStage02QuantificationSPLSScoresAndLoadings_js(self,analysis_id_I,axis_I=3,data_dir_I='tmp'):
        ...
        data_scores,data_loadings = self.get_RExpressionData_analysisID_dataStage02QuantificationSPLSScoresLoadings(analysis_id_I,axis_I);
        # reformat the data
        data_scores_123,data_loadings_123 = [],[];
        data_scores = self.get_rowAxisDict_analysisID_dataStage02QuantificationSPLSScores(analysis_id_I,axis_I)
        data_loadings = self.get_rowAxisDict_analysisID_dataStage02QuantificationSPLSLoadings(analysis_id_I,axis_I)
        data_scores_123,data_loadings_123 = {},{};
    ...
    def export_dataStage02QuantificationSPLSBiPlotAndValidation_js(self,analysis_id_I,data_dir_I='tmp'):
        '''
        Export the bi plot for the SPLS components and validation plots for the pls model
        OUTPUT:
        ...
        #get the biplot data
        biplot_O = [];
        biplot_tmp = self.get_biPlotData_analysisID_dataStage02QuantificationSPLSScores(analysis_id_I);
        ...
        validation_O = [];
        validation_tmp = self.get_rows_analysisID_dataStage02QuantificationSPLSValidation(analysis_id_I);
    ...
    def export_dataStage02QuantificationSPLSVIPs_js(self,analysis_id_I,data_dir_I='tmp'):
        '''
        Export the SPLS VIPs
        OUTPUT:
        horizontal bar plot of VIPs
        '''
        #get the biplot data
        vip_O = [];
        vip_O = self.get_rows_analysisID_dataStage02QuantificationSPLSVIP(analysis_id_I);
        #vip_O = self.get_VIPs_analysisID_dataStage02QuantificationSPLSLoadings(analysis_id_I);
